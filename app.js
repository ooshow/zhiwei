...
App({
  onLaunch: function () {
    ...
    wx.request({
      ...
      success: function (res) {
        console.log("背景图片"+res.data.value);
        if (res.code == 0) {
          wx.setStorageSync('bgImage', res.data.value);
        }
      }
    })
    // 获取新用户优惠券ID
  ...
  globalData:{
    userInfo:null,
    subDomain: "6254afebd785ba7e07ab02f046952b5d", // 如果你的域名是： https://api.it120.cc/abcd 那么这里只要填写 abcd
    version: "1.1.0",
